          ...
          {activeTab === 'general' && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <ImageUpload
                  maxImages={1}
                  existingImages={settings.general.logo_url ? [settings.general.logo_url] : []}
                  onUploadComplete={(images) => handleInputChange('general', 'logo_url', images[0] || '')}
                  label={language === 'ar' ? 'شعار' : language === 'en' ? 'Logo' : 'Logo'}
                />
              </div>
