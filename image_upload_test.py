...
class ImageUploadTester:
    def __init__(self, base_url="https://tresors-shop.preview.emergentagent.com/api"):
    ...
    def test_static_file_serving(self):
        ...
        static_url = f"https://tresors-shop.preview.emergentagent.com/api/uploads/{filename}"
